      ...
      <header className="relative z-10 border-b border-neutral-800/80 backdrop-blur bg-black/40">
        <div className="mx-auto max-w-5xl px-6 py-4 flex items-center justify-between">
          ...
          <a
            ...
            className="hidden sm:inline-flex items-center gap-2 rounded-full border border-emerald-400/40 bg-emerald-500/10 px-4 py-1.5 text-xs font-medium text-emerald-200 shadow-xs hover:bg-emerald-500/20 transition"
          >
            Join via integrated.bluearmy.uk
      ...
      <main className="flex-1">
        ...
        <section className="border-t border-neutral-900/80 bg-black/40">
          <div className="mx-auto flex max-w-5xl px-6 py-6">
            <div className="w-full rounded-lg border border-neutral-800/80 bg-neutral-950/70 p-4 text-xs">
